...
void particleFilter(int * I, int IszX, int IszY, int Nfr, int * seed, int Nparticles) 
{
    ...
    total_size += sizeof(double)*Nparticles*4;
#ifndef OMP_OFFLOAD_NOREUSE
#pragma omp target data map(alloc: weights[0:Nparticles]) \
                        map(alloc: arrayX[0:Nparticles]) \
                        map(alloc: arrayY[0:Nparticles]) \
                        map(alloc: u[0:Nparticles])
#endif
    {
#ifdef OMP_OFFLOAD_NOREUSE
        printf("No reuse 1\n");
    total_size += sizeof(double)*Nparticles;
#pragma omp target data map(weights[0:Nparticles])
#else
        printf("reuse 1\n");
    total_size += sizeof(double)*Nparticles/2;
#pragma omp target data map(weights[0:Nparticles])
#endif
        printf("Hi\n");
...
#pragma omp target teams distribute parallel for 
    ...
    //initial likelihood to 0.0
        ...
        printf("No reuse 2\n");
    total_size += sizeof(double)*Nparticles*2;
#pragma omp target data map(arrayX[0:Nparticles], arrayY[0:Nparticles], xe, ye)
#else
        printf("reuse 2\n");
    total_size += sizeof(double)*Nparticles;
#pragma omp target data map(from:arrayX[0:Nparticles], arrayY[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for 
...
#ifdef OMP_OFFLOAD_NOREUSE
        printf("No reuse 3\n");
    total_size += sizeof(double)*Nparticles + sizeof(double);
#pragma omp target data map(weights[0:Nparticles], sumWeights)
#else
    total_size += sizeof(double)*Nparticles/2;
#pragma omp target data map(to:weights[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for private(x) reduction(+:sumWeights)
        for(x = 0; x < Nparticles; x++){
...
#pragma omp target data map(weights[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for shared(sumWeights, weights) private(x)
        for(x = 0; x < Nparticles; x++){
...
#ifdef OMP_OFFLOAD_NOREUSE
        printf("No reuse 5\n");
    total_size += sizeof(double)*Nparticles*3;
#pragma omp target data map(weights[0:Nparticles], arrayX[0:Nparticles], arrayY[0:Nparticles])
#else
    total_size += sizeof(double)*Nparticles;
#pragma omp target data map(to: arrayX[0:Nparticles], arrayY[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for private(x) reduction(+:xe, ye)
        for(x = 0; x < Nparticles; x++){
        ...
        printf("No reuse 6\n");
    total_size += sizeof(double)*Nparticles;
#pragma omp target data map(u[0:Nparticles])
#else
    total_size += sizeof(double)*Nparticles/2;
#pragma omp target data map(from:u[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for shared(u, u1, Nparticles) private(x)
        for(x = 0; x < Nparticles; x++){
...
#ifdef OMP_OFFLOAD_NOREUSE
        printf("No reuse 7\n");
    total_size += sizeof(double)*Nparticles*5;
#pragma omp target data map(arrayX[0:Nparticles],arrayY[0:Nparticles], xj[0:Nparticles],yj[0:Nparticles],weights[0:Nparticles])
#else
    total_size += sizeof(double)*Nparticles;
#pragma omp target data map(to: xj[0:Nparticles],yj[0:Nparticles])
#endif
#pragma omp target teams distribute parallel for shared(weights, Nparticles) private(x)
        for(x = 0; x < Nparticles; x++){
